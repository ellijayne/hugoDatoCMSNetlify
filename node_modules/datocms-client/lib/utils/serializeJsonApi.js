...
function serializedAttributes(type) {
  ...
  var attrs = type === 'item' ? (0, _arrDiff.default)(Object.keys((0, _humps.decamelizeKeys)(unserializedBody)), ['item_type', 'id', 'created_at', 'updated_at', 'creator']) : findAttributes(schema);
