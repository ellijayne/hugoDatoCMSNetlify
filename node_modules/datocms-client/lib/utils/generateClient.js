              ...
              return schemaPromise.then(function (schema) {
                ...
                if (link.method === 'POST') {
                  return rawClient.post("".concat(url), body).then(function (response) {
                    return Promise.resolve((0, _deserializeJsonApi.default)(link, response));
                  });
                }
                ...
                return request.then(function (response) {
                  return Promise.resolve(deserializeResponse ? (0, _deserializeJsonApi.default)(link, response) : response);
                });
              });
            };
          }
